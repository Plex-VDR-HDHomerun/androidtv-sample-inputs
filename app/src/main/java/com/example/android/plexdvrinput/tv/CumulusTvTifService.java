package com.example.android.plexdvrinput.tv;
...
import com.example.android.plexdvrinput.player.LeanbackWebPlayer;
import com.example.android.plexdvrinput.player.MediaSourceFactory;
import com.example.android.plexdvrinput.services.CumulusJobService;
import com.example.android.plexdvrinput.player.source.PositionReference;
...
public class CumulusTvTifService extends BaseTvInputService {
    ...
    class RichTvInputSessionImpl extends BaseTvInputService.Session {
        ...
        public View onCreateOverlayView() {
            ...
            try {
                ...
                if (jsonChannel == null) {
                    ...
                    LeanbackWebPlayer wv = new LeanbackWebPlayer(getApplicationContext(),
                            new LeanbackWebPlayer.WebViewListener() {
                                @Override
        ...
        private void createPlayer(int videoType, Uri videoUrl) {
            ...
            mPlayer.registerErrorListener(new LeanbackPlayer.ErrorListener() {
                @Override
