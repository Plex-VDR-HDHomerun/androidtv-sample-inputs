...
public class XmlTvParser {
    ...
    private static Channel parseChannel(XmlPullParser parser)
        ...
        return new Channel(id, displayName, displayNumber, icon, fakeOriginalNetworkId, 0, 0,
                repeatPrograms);
    }
    ...
    private static Program parseProgram(XmlPullParser parser)
        ...
        return new Program(channelId, title, description, icon,
    ...
    public static class Channel {
        ...
        public Channel(String id, String displayName, String displayNumber, XmlTvIcon icon,
    ...
    public static class Program {
        ...
        private Program(String channelId, String title, String description, XmlTvIcon icon,
