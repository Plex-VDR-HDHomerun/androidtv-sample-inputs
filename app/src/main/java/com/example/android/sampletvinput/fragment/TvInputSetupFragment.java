package com.example.android.sampletvinput.fragment;
...
import com.example.android.sampletvinput.player.utils.SyncUtil;
import com.example.android.sampletvinput.player.utils.TvContractUtils;
 ...
 */
public class TvInputSetupFragment extends BrowseFragment  {
    private static final String TAG = TvInputSetupFragment.class.getSimpleName();
    ...
    private void setupChannels(String inputId) {
        ...
        com.example.android.sampletvinput.utils.TvContractUtils.updateChannels(getActivity(), inputId, tvListing.channels);
