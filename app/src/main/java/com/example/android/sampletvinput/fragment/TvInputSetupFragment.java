 ...
 */
public class TvInputSetupFragment extends ChannelSetupFragment {
    ...
    public void onScanStarted() {
        ...
        SyncJobService.requestImmediateSync1(getActivity(), mInputId, SyncJobService.DEFAULT_IMMEDIATE_EPG_DURATION_MILLIS,
                new ComponentName(getActivity(), SyncJobService.class));
